...
export function CinematicIntro() {
  ...
  const renderFrame = () => {
    ...
    const scale = Math.min(maxW / video.videoWidth, maxH / video.videoHeight) * BAG_DISPLAY_SCALE;
      ...
      <div className="sticky top-16 h-[calc(100svh-4rem)] w-full overflow-hidden bg-background">
        ...
        <div className="absolute inset-0 z-20 flex items-center justify-center px-6 pb-12 pt-28 sm:px-10 sm:pt-32">
          <canvas
            ...
            aria-label="Islandvoguemv hero handbag animation"
          />
        </div>
        ...
        {/* Brands revealed after the camera enters the bag */}
        <div
        ...
        >
          <BrandsMarquee variant="vertical" />
        </div>
